...
Secret keys, API keys, and webhook signing secrets are sensitive. If you find
any place where the package logs, exposes, or mishandles them, report it —
even if you cannot demonstrate full exploitation.
